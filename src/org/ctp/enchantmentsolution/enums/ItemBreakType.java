...
public enum ItemBreakType {
	...
	private List<String> getSilkTouchStrings(){
		...
		switch (name()) {
			...
			case "GOLDEN_PICKAXE":
			case "WOODEN_PICKAXE":
				itemTypes.addAll(Arrays.asList("ENDER_CHEST", "NETHER_GOLD_ORE", "ICE", "PACKED_ICE", "BLUE_ICE", "COAL_ORE", "NETHER_QUARTZ_ORE", "STONE", "BRAIN_CORAL_BLOCK", "BUBBLE_CORAL_BLOCK", "FIRE_CORAL_BLOCK", "HORN_CORAL_BLOCK", "TUBE_CORAL_BLOCK"));
				return itemTypes;
			case "NETHERITE_AXE":
			case "DIAMOND_AXE":
			case "GOLDEN_AXE":
