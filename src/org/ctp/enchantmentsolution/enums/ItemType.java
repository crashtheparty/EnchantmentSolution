...
public enum ItemType {
	...
	private List<String> getItemStrings(String type) {
		...
		if (ALL.getType().equals(type)) {
			...
			itemTypes.addAll(Arrays.asList("NETHERITE_AXE", "DIAMOND_AXE", "GOLDEN_AXE", "IRON_AXE", "STONE_AXE", "WOODEN_AXE"));
			return itemTypes;
		} else if (BOOK.getType().equals(type)) return itemTypes;
		else if (BOOTS.getType().equals(type)) {
			itemTypes.addAll(Arrays.asList("NETHERITE_BOOTS", "DIAMOND_BOOTS", "CHAINMAIL_BOOTS", "GOLDEN_BOOTS", "IRON_BOOTS", "LEATHER_BOOTS"));
			return itemTypes;
			...
			itemTypes.addAll(Arrays.asList("NETHERITE_CHESTPLATE", "DIAMOND_CHESTPLATE", "CHAINMAIL_CHESTPLATE", "GOLDEN_CHESTPLATE", "IRON_CHESTPLATE", "LEATHER_CHESTPLATE"));
			return itemTypes;
		} else if (CROSSBOW.getType().equals(type)) {
			itemTypes.addAll(Arrays.asList("CROSSBOW"));
			return itemTypes;
		} else if (DIAMOND_ARMOR.getType().equals(type)) {
			itemTypes.addAll(Arrays.asList("DIAMOND_HELMET", "DIAMOND_CHESTPLATE", "DIAMOND_LEGGINGS", "DIAMOND_BOOTS"));
			return itemTypes;
		} else if (DIAMOND_TOOLS.getType().equals(type)) {
			itemTypes.addAll(Arrays.asList("DIAMOND_AXE", "DIAMOND_SWORD", "DIAMOND_SHOVEL", "DIAMOND_PICKAXE", "DIAMOND_HOE"));
			return itemTypes;
			...
			itemTypes.addAll(Arrays.asList("GOLDEN_AXE", "GOLDEN_SWORD", "GOLDEN_SHOVEL", "GOLDEN_PICKAXE", "GOLDEN_HOE"));
			return itemTypes;
		} else if (HELMETS.getType().equals(type)) {
			itemTypes.addAll(Arrays.asList("NETHERITE_HELMET", "DIAMOND_HELMET", "CHAINMAIL_HELMET", "GOLDEN_HELMET", "IRON_HELMET", "LEATHER_HELMET", "TURTLE_HELMET"));
			return itemTypes;
		} else if (HOES.getType().equals(type)) {
			itemTypes.addAll(Arrays.asList("NETHERITE_HOE", "DIAMOND_HOE", "GOLDEN_HOE", "IRON_HOE", "STONE_HOE", "WOODEN_HOE"));
			return itemTypes;
			...
			itemTypes.addAll(Arrays.asList("IRON_AXE", "IRON_SWORD", "IRON_SHOVEL", "IRON_PICKAXE", "IRON_HOE"));
			return itemTypes;
		} else if (LEATHER_ARMOR.getType().equals(type)) {
			itemTypes.addAll(Arrays.asList("LEATHER_HELMET", "LEATHER_CHESTPLATE", "LEATHER_LEGGINGS", "LEATHER_BOOTS"));
			return itemTypes;
		} else if (LEGGINGS.getType().equals(type)) {
			itemTypes.addAll(Arrays.asList("NETHERITE_LEGGINGS", "DIAMOND_LEGGINGS", "CHAINMAIL_LEGGINGS", "GOLDEN_LEGGINGS", "IRON_LEGGINGS", "LEATHER_LEGGINGS"));
			return itemTypes;
			...
			itemTypes.addAll(getItemStrings(HOES.getType()));
			return itemTypes;
		} else if (NETHERITE_ARMOR.getType().equals(type)) {
			itemTypes.addAll(Arrays.asList("NETHERITE_HELMET", "NETHERITE_CHESTPLATE", "NETHERITE_LEGGINGS", "NETHERITE_BOOTS"));
			return itemTypes;
		} else if (NETHERITE_TOOLS.getType().equals(type)) {
			itemTypes.addAll(Arrays.asList("NETHERITE_AXE", "NETHERITE_SWORD", "NETHERITE_SHOVEL", "NETHERITE_PICKAXE", "NETHERITE_HOE"));
			return itemTypes;
			...
			itemTypes.addAll(Arrays.asList("NETHERITE_PICKAXE", "DIAMOND_PICKAXE", "GOLDEN_PICKAXE", "IRON_PICKAXE", "STONE_PICKAXE", "WOODEN_PICKAXE"));
			return itemTypes;
			...
			itemTypes.addAll(Arrays.asList("NETHERITE_SHOVEL", "DIAMOND_SHOVEL", "GOLDEN_SHOVEL", "IRON_SHOVEL", "STONE_SHOVEL", "WOODEN_SHOVEL"));
			return itemTypes;
		} else if (STONE_TOOLS.getType().equals(type)) {
			itemTypes.addAll(Arrays.asList("STONE_AXE", "STONE_SWORD", "STONE_SHOVEL", "STONE_PICKAXE", "STONE_HOE"));
			return itemTypes;
		} else if (SWORDS.getType().equals(type)) {
			itemTypes.addAll(Arrays.asList("NETHERITE_SWORD", "DIAMOND_SWORD", "GOLDEN_SWORD", "IRON_SWORD", "STONE_SWORD", "WOODEN_SWORD"));
			return itemTypes;
			...
			itemTypes.addAll(Arrays.asList("WOODEN_AXE", "WOODEN_SWORD", "WOODEN_SHOVEL", "WOODEN_PICKAXE", "WOODEN_HOE"));
			return itemTypes;
		}
		return null;
	}
