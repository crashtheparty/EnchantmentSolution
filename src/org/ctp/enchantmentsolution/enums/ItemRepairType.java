...
public enum ItemRepairType {
	DIAMOND_AXE(), DIAMOND_SWORD(), DIAMOND_SHOVEL(), DIAMOND_PICKAXE(), DIAMOND_HOE(), DIAMOND_HELMET(), DIAMOND_CHESTPLATE(), DIAMOND_LEGGINGS(), DIAMOND_BOOTS(), IRON_AXE(), IRON_SWORD(), IRON_SHOVEL(), IRON_PICKAXE(), IRON_HOE(), IRON_HELMET(), IRON_CHESTPLATE(), IRON_LEGGINGS(), IRON_BOOTS(), GOLDEN_AXE(), GOLDEN_SWORD(), GOLDEN_SHOVEL(), GOLDEN_PICKAXE(), GOLDEN_HOE(), GOLDEN_HELMET(), GOLDEN_CHESTPLATE(), GOLDEN_LEGGINGS(), GOLDEN_BOOTS(), STONE_AXE(), STONE_SWORD(), STONE_SHOVEL(), STONE_PICKAXE(), STONE_HOE(), CHAINMAIL_HELMET(), CHAINMAIL_CHESTPLATE(), CHAINMAIL_LEGGINGS(), CHAINMAIL_BOOTS(), WOODEN_AXE(), WOODEN_SWORD(), WOODEN_SHOVEL(), WOODEN_PICKAXE(), WOODEN_HOE(), LEATHER_HELMET(), LEATHER_CHESTPLATE(), LEATHER_LEGGINGS(), LEATHER_BOOTS(), ELYTRA(), BOW(), FISHING_ROD(), BOOK(), ENCHANTED_BOOK(), TRIDENT(), SHEARS(), FLINT_AND_STEEL(), CROSSBOW(), SHIELD(), TURTLE_HELMET(), CARROT_ON_A_STICK(), BLACK_SHULKER_BOX(), BLUE_SHULKER_BOX(), BROWN_SHULKER_BOX(), CYAN_SHULKER_BOX(), GRAY_SHULKER_BOX(), GREEN_SHULKER_BOX(), LIGHT_BLUE_SHULKER_BOX(), LIME_SHULKER_BOX(), MAGENTA_SHULKER_BOX(), ORANGE_SHULKER_BOX(), PINK_SHULKER_BOX(), PURPLE_SHULKER_BOX(), RED_SHULKER_BOX(), LIGHT_GRAY_SHULKER_BOX(), WHITE_SHULKER_BOX(), YELLOW_SHULKER_BOX(), SHULKER_BOX();
