...
public enum ItemRepairType{
	...
	private List<String> getRepairStrings() {
		...
		case "DIAMOND_SHOVEL":
		case "DIAMOND_SWORD":
			itemTypes.addAll(Arrays.asList(this.name(), "DIAMOND"));
			break;
		case "ELYTRA":
		...
		case "BOW":
		case "FISHING_ROD":
			itemTypes.addAll(Arrays.asList(this.name(), "STRING"));
			break;
		case "GOLDEN_AXE":
		case "GOLDEN_BOOTS":
		...
		case "GOLDEN_SHOVEL":
		case "GOLDEN_SWORD":
			itemTypes.addAll(Arrays.asList(this.name(), "GOLD_INGOT"));
			break;
		...
		case "IRON_SWORD":
		case "SHEARS":
			itemTypes.addAll(Arrays.asList(this.name(), "IRON_INGOT"));
			break;
		case "LEATHER_BOOTS":
		case "LEATHER_CHESTPLATE":
		case "LEATHER_HELMET":
		case "LEATHER_LEGGINGS":
			itemTypes.addAll(Arrays.asList(this.name(), "LEATHER"));
			break;
		case "STONE_AXE":
		case "STONE_HOE":
		case "STONE_PICKAXE":
		case "STONE_SHOVEL":
		case "STONE_SWORD":
			itemTypes.addAll(Arrays.asList(this.name(), "COBBLESTONE"));
			break;
		case "TURTLE_HELMET":
		...
		case "WOODEN_SHOVEL":
		case "WOODEN_SWORD":
			itemTypes.addAll(Arrays.asList(this.name(), "ACACIA_PLANKS", "BIRCH_PLANKS", "DARK_OAK_PLANKS", 
