...
public enum ItemMoisturizeType {
	...
	"BLUE_GLAZED_TERRACOTTA", "BROWN_GLAZED_TERRACOTTA", "CYAN_GLAZED_TERRACOTTA", "GRAY_GLAZED_TERRACOTTA",
	"GREEN_GLAZED_TERRACOTTA", "LIGHT_BLUE_GLAZED_TERRACOTTA", "LIGHT_GRAY_GLAZED_TERRACOTTA",
	...
	"CRACKED_STONE_BRICKS", "SMOOTH_QUARTZ", "SMOOTH_RED_SANDSTONE", "SMOOTH_SANDSTONE", "SMOOTH_STONE");
	private static List<String> WET_ITEMS = Arrays.asList("BLACK_CONCRETE_POWDER", "BLUE_CONCRETE_POWDER",
	"BROWN_CONCRETE_POWDER", "CYAN_CONCRETE_POWDER", "GRAY_CONCRETE_POWDER", "GREEN_CONCRETE_POWDER",
	"LIGHT_BLUE_CONCRETE_POWDER", "LIGHT_GRAY_CONCRETE_POWDER", "LIME_CONCRETE_POWDER",
	"MAGENTA_CONCRETE_POWDER", "ORANGE_CONCRETE_POWDER", "PINK_CONCRETE_POWDER", "PURPLE_CONCRETE_POWDER",
	"RED_CONCRETE_POWDER", "WHITE_CONCRETE_POWDER", "YELLOW_CONCRETE_POWDER");
	...
	public static Material getWet(Material mat) {
		if (WET_ITEMS.contains(mat.name())) {
			return Material.valueOf(mat.name().replace("_POWDER", ""));
		}
		return null;
	}
