...
public class ESArrays {
	...
	private static List<String> REPAIR_MATERIALS = Arrays.asList("DIAMOND", "IRON_INGOT", "COBBLESTONE", "ACACIA_PLANKS", "BIRCH_PLANKS", "DARK_OAK_PLANKS", "JUNGLE_PLANKS", "OAK_PLANKS", "DARK_OAK_PLANKS", "LEATHER", "PHANTOM_MEMBRANE", "STRING");
