...
public enum ItemBreakType {
	DIAMOND_AXE(), DIAMOND_SHOVEL(), DIAMOND_PICKAXE(), IRON_AXE(), IRON_SHOVEL(), IRON_PICKAXE(), GOLDEN_AXE(), GOLDEN_SHOVEL(), GOLDEN_PICKAXE(), 
	STONE_AXE(), STONE_SHOVEL(), STONE_PICKAXE(), WOODEN_AXE(), WOODEN_SHOVEL(), WOODEN_PICKAXE();
	
	private List<Material> breakTypes;
	
	ItemBreakType() {
		this.breakTypes = getItemBreakMaterials();
	}
	...
	private List<String> getItemBreakStrings(){
		...
		case "WOODEN_PICKAXE":
			itemTypes.addAll(Arrays.asList("ICE", "PACKED_ICE", "FROSTED_ICE", "BLUE_ICE", "REDSTONE_BLOCK", "IRON_BARS", "ACTIVATOR_RAIL", "DETECTOR_RAIL", 
					...
					"CYAN_TERRACOTTA", "GRAY_TERRACOTTA", "GREEN_TERRACOTTA", "LIGHT_BLUE_TERRACOTTA", "LIGHT_GRAY_TERRACOTTA", "LIME_TERRACOTTA", 
					"MAGENTA_TERRACOTTA", "ORANGE_TERRACOTTA", "PINK_TERRACOTTA", "PURPLE_TERRACOTTA", "RED_TERRACOTTA", "WHITE_TERRACOTTA", "YELLOW_TERRACOTTA", 
					"STONE", "STONE_BRICKS", "MOSSY_STONE_BRICKS", "CRACKED_STONE_BRICKS", "CHISELED_STONE_BRICKS", "INFESTED_CHISELED_STONE_BRICKS", 
					"INFESTED_COBBLESTONE", "INFESTED_CRACKED_STONE_BRICKS", "INFESTED_MOSSY_STONE_BRICKS", "INFESTED_STONE", "INFESTED_STONE_BRICKS", 
		...
		case "WOODEN_AXE":
			itemTypes.addAll(Arrays.asList("COCOA", "JACK_O_LANTERN", "PUMPKIN", "MELON", "BOOKSHELF", "ACACIA_FENCE", "ACACIA_FENCE_GATE", "BIRCH_FENCE", 
					...
					"JUNGLE_PLANKS", "OAK_LOG", "OAK_PLANKS", "SPRUCE_LOG", "SPRUCE_PLANKS", "ACACIA_WOOD", "BIRCH_WOOD", "DARK_OAK_WOOD", "JUNGLE_WOOD", "OAK_WOOD", 
					"SPRUCE_WOOD", "STRIPPED_ACACIA_LOG", "STRIPPED_BIRCH_LOG", "STRIPPED_DARK_OAK_LOG", "STRIPPED_JUNGLE_LOG", "STRIPPED_OAK_LOG", 
