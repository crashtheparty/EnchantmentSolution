...
public class ItemPlaceType_v1_13 implements ItemPlaceType{
	...
	public List<Material> getItemPlaceTypes(){
		...
		itemTypes.addAll(Arrays.asList(Material.IRON_BLOCK, Material.LAPIS_BLOCK, Material.IRON_ORE, Material.LAPIS_ORE, Material.DIAMOND_BLOCK, Material.EMERALD_BLOCK, 
				...
				Material.PUMPKIN, Material.MELON, Material.BOOKSHELF, Material.ACACIA_LOG, Material.ACACIA_PLANKS, Material.BIRCH_LOG, Material.BIRCH_PLANKS, 
				Material.DARK_OAK_LOG, Material.DARK_OAK_PLANKS, Material.JUNGLE_LOG, Material.JUNGLE_PLANKS, Material.OAK_LOG, Material.OAK_PLANKS, Material.SPRUCE_LOG, 
				Material.SPRUCE_PLANKS, Material.ACACIA_WOOD, Material.BIRCH_WOOD, Material.DARK_OAK_WOOD, Material.JUNGLE_WOOD, Material.OAK_WOOD, Material.SPRUCE_WOOD, 
				...
				Material.STRIPPED_SPRUCE_LOG,Material.STRIPPED_ACACIA_WOOD, Material.STRIPPED_BIRCH_WOOD, Material.STRIPPED_DARK_OAK_WOOD, Material.STRIPPED_JUNGLE_WOOD, 
				Material.STRIPPED_OAK_WOOD, Material.STRIPPED_SPRUCE_WOOD, Material.BROWN_MUSHROOM_BLOCK, Material.RED_MUSHROOM_BLOCK, Material.ICE, Material.PACKED_ICE, 
				Material.FROSTED_ICE, Material.BLUE_ICE, Material.REDSTONE_BLOCK, Material.ANDESITE, Material.COAL_BLOCK, Material.QUARTZ_BLOCK, Material.BRICKS, 
				Material.COAL_ORE, Material.COBBLESTONE, Material.BLACK_CONCRETE, Material.BLUE_CONCRETE, Material.BROWN_CONCRETE, Material.CYAN_CONCRETE, 
				...
				Material.MAGENTA_CONCRETE, Material.ORANGE_CONCRETE, Material.PINK_CONCRETE, Material.PURPLE_CONCRETE, Material.RED_CONCRETE, Material.WHITE_CONCRETE, 
				Material.YELLOW_CONCRETE, Material.DARK_PRISMARINE, Material.DIORITE, Material.END_STONE, Material.END_STONE_BRICKS, Material.TERRACOTTA, 
				...
				Material.PURPLE_GLAZED_TERRACOTTA, Material.RED_GLAZED_TERRACOTTA, Material.WHITE_GLAZED_TERRACOTTA, Material.YELLOW_GLAZED_TERRACOTTA, Material.GRANITE, 
				Material.MOSSY_COBBLESTONE, Material.MOSSY_COBBLESTONE_WALL, Material.NETHER_BRICK, Material.NETHER_BRICK_FENCE, Material.NETHER_QUARTZ_ORE, 
				Material.NETHERRACK, Material.POLISHED_ANDESITE, Material.POLISHED_DIORITE, Material.POLISHED_GRANITE, Material.PRISMARINE, Material.PRISMARINE_BRICKS, 
				...
				Material.SMOOTH_STONE, Material.SMOOTH_QUARTZ, Material.MAGMA_BLOCK, Material.SMOOTH_RED_SANDSTONE, Material.SMOOTH_SANDSTONE, Material.SNOW_BLOCK, 
				Material.CLAY, Material.COARSE_DIRT, Material.DIRT, Material.GRASS_BLOCK, Material.GRAVEL, Material.MYCELIUM, Material.PODZOL, Material.RED_SAND, 
				Material.SAND, Material.SOUL_SAND, Material.BLACK_CONCRETE_POWDER, Material.BLUE_CONCRETE_POWDER, Material.BROWN_CONCRETE_POWDER, 
