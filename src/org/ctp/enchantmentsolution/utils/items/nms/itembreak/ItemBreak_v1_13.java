	...
	private List<Material> getItemBreakTypes(Material type){
		...
		case WOODEN_PICKAXE:
			itemTypes.addAll(Arrays.asList(Material.ICE, Material.PACKED_ICE, Material.FROSTED_ICE, Material.BLUE_ICE, Material.REDSTONE_BLOCK, Material.IRON_BARS, 
					...
					Material.DARK_PRISMARINE, Material.DIORITE, Material.END_STONE, Material.END_STONE_BRICKS, Material.TERRACOTTA, Material.BLACK_GLAZED_TERRACOTTA, 
					...
					Material.SMOOTH_STONE, Material.SMOOTH_QUARTZ, Material.MAGMA_BLOCK, Material.SMOOTH_RED_SANDSTONE, Material.SMOOTH_SANDSTONE));
			return itemTypes;
		case DIAMOND_SHOVEL:
		case IRON_SHOVEL:
		case GOLDEN_SHOVEL:
