...
public enum ConfigString {
	...
	REPAIR_COST_LIMIT(Type.MAIN, "anvil.repair_cost_limit", int.class),
	NO_UPGRADE_BOOKS(Type.MAIN, "anvil.no_upgrade_books", boolean.class),
	NO_UPGRADE_NON_BOOKS(Type.MAIN, "anvil.no_upgrade_non_books", boolean.class),
	NO_UPGRADE_BOOKS_TO_NON_BOOKS(Type.MAIN, "anvil.no_upgrade_books_to_non_books", boolean.class),
	...
	ALLOW_NO_ENCHANTMENTS(Type.MAIN, "loots.allow_no_enchantments", boolean.class),
	...
	MULTI_BLOCK_DELAY(Type.MAIN, "multi_block.delay_on_timeout", int.class),
