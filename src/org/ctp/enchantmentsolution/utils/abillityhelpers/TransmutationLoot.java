...
public enum TransmutationLoot {
	RAW_SALMON(Material.SALMON, 1200, 1, 2), RAW_COD(Material.COD, 1200, 1, 2),
	TROPICAL_FISH(Material.TROPICAL_FISH, 750, 1, 1), PUFFERFISH(Material.PUFFERFISH, 400, 1, 1),
	KELP(Material.KELP, 400, 1, 4), TRIDENT(Material.TRIDENT, 8, 1, 1), SCUTE(Material.SCUTE, 300, 1, 2),
	TURTLE_EGG(Material.TURTLE_EGG, 50, 1, 1), INK_SAC(Material.INK_SAC, 1000, 1, 4),
	PRISMARINE_SHARD(Material.PRISMARINE_SHARD, 750, 1, 3),
	PRISMARINE_CRYSTALS(Material.PRISMARINE_CRYSTALS, 500, 1, 3), NAUTILUS_SHELL(Material.NAUTILUS_SHELL, 140, 1, 1),
	HEART_OF_THE_SEA(Material.HEART_OF_THE_SEA, 2, 1, 1), BRAIN_CORAL(Material.BRAIN_CORAL, 100, 1, 4),
	BUBBLE_CORAL(Material.BUBBLE_CORAL, 100, 1, 4), FIRE_CORAL(Material.FIRE_CORAL, 100, 1, 4),
	HORN_CORAL(Material.HORN_CORAL, 100, 1, 4), TUBE_CORAL(Material.TUBE_CORAL, 100, 1, 4),
	BRAIN_CORAL_FAN(Material.BRAIN_CORAL_FAN, 100, 1, 4), BUBBLE_CORAL_FAN(Material.BUBBLE_CORAL_FAN, 100, 1, 4),
	FIRE_CORAL_FAN(Material.FIRE_CORAL_FAN, 100, 1, 4), HORN_CORAL_FAN(Material.HORN_CORAL_FAN, 100, 1, 4),
	TUBE_CORAL_FAN(Material.TUBE_CORAL_FAN, 100, 1, 4), BRAIN_CORAL_BLOCK(Material.BRAIN_CORAL_BLOCK, 300, 1, 1),
	BUBBLE_CORAL_BLOCK(Material.BUBBLE_CORAL_BLOCK, 300, 1, 1), FIRE_CORAL_BLOCK(Material.FIRE_CORAL_BLOCK, 300, 1, 1),
	HORN_CORAL_BLOCK(Material.HORN_CORAL_BLOCK, 300, 1, 1), TUBE_CORAL_BLOCK(Material.TUBE_CORAL_BLOCK, 300, 1, 1),
	SPONGE(Material.SPONGE, 400, 1, 1), SEA_PICKLE(Material.SEA_PICKLE, 400, 1, 4);
