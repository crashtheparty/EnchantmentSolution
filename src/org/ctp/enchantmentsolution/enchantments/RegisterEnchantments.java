...
public class RegisterEnchantments {
	...
	public static void addEnchantments() {
		...
		if (VersionUtils.isSimilarOrAbove(1, 21, 0)) addDefaultEnchantment(CERegister.BREACH);
		...
		if (VersionUtils.isSimilarOrAbove(1, 21, 0)) addDefaultEnchantment(CERegister.DENSITY);
		...
		if (VersionUtils.isSimilarOrAbove(1, 21, 0)) addDefaultEnchantment(CERegister.WIND_BURST);
