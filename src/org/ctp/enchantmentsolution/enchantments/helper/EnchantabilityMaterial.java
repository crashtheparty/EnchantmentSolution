...
public enum EnchantabilityMaterial {
	WOODEN_TOOLS(15, "WOODEN_PICKAXE", "calc.enchantability_values.wooden_tools", ItemType.WOODEN_ITEMS.getEnchantMaterials()),
	STONE_TOOLS(5, "STONE_PICKAXE", "calc.enchantability_values.stone_tools", ItemType.STONE_ITEMS.getEnchantMaterials()),
	GOLDEN_TOOLS(22, "GOLDEN_PICKAXE", "calc.enchantability_values.golden_tools", ItemType.GOLDEN_ITEMS.getEnchantMaterials()),
	IRON_TOOLS(14, "IRON_PICKAXE", "calc.enchantability_values.iron_tools", ItemType.IRON_ITEMS.getEnchantMaterials()),
	DIAMOND_TOOLS(10, "DIAMOND_PICKAXE", "calc.enchantability_values.diamond_tools", ItemType.DIAMOND_ITEMS.getEnchantMaterials()),
	...
	NETHERITE_TOOLS(15, "NETHERITE_PICKAXE", "calc.enchantability_values.netherite_tools", ItemType.NETHERITE_ITEMS.getEnchantMaterials()),
