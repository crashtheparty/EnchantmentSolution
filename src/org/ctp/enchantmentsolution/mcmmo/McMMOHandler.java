...
//			 num--;
//			 }
//			 event.getBlock().getState().removeMetadata(mcMMO.BONUS_DROPS_METAKEY,
//			 mcMMO.p);
//			 }
//			 }
...
//			 drop = smelted.clone();
//			 }
//			 if (!Config.getInstance().getDoubleDropsEnabled(PrimarySkillType.MINING,
//			 block.getType())
//			 && !Config.getInstance().getDoubleDropsEnabled(PrimarySkillType.HERBALISM,
//			 block.getType())
//			 && !Config.getInstance().getDoubleDropsEnabled(PrimarySkillType.WOODCUTTING,
//			 block.getType()))
//			 return;
//			 if(state.getMetadata(mcMMO.BONUS_DROPS_METAKEY).size() > 0) {
//			 for(MetadataValue value : state.getMetadata(mcMMO.BONUS_DROPS_METAKEY)) {
