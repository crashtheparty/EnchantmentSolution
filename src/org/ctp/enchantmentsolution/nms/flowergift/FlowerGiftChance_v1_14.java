...
public enum FlowerGiftChance_v1_14 implements FlowerGiftChance{
	...
	PEONY(Material.PEONY, 1), SUNFLOWER(Material.SUNFLOWER, 1), CORNFLOWER(Material.CORNFLOWER, .5), LILY_OF_THE_VALLEY(Material.LILY_OF_THE_VALLEY, .5),
	WITHER_ROSE(Material.WITHER_ROSE, 0.01);
