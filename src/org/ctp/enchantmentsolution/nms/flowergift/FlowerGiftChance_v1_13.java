...
public enum FlowerGiftChance_v1_13 implements FlowerGiftChance {
	DANDELION(Material.DANDELION, .5), POPPY(Material.POPPY, .5), BLUE_ORCHID(Material.BLUE_ORCHID, .5), ALLIUM(
			Material.ALLIUM, .5), AZURE_BLUET(Material.AZURE_BLUET, .5), RED_TULIP(Material.RED_TULIP,
					.5), ORANGE_TULIP(Material.ORANGE_TULIP, .5), WHITE_TULIP(Material.WHITE_TULIP,
							.5), PINK_TULIP(Material.PINK_TULIP, .5), OXEYE_DAISY(Material.OXEYE_DAISY,
									.5), LILAC(Material.LILAC, 1), ROSE_BUSH(Material.ROSE_BUSH,
											1), PEONY(Material.PEONY, 1), SUNFLOWER(Material.SUNFLOWER, 1);
