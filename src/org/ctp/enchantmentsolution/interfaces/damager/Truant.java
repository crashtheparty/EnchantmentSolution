...
public class Truant extends DamagerAfflictEffect {

	public Truant() {
		super(RegisterEnchantments.TRUANT, EnchantmentMultipleType.HIGHEST, EnchantmentItemLocation.ATTACKED, EventPriority.HIGHEST, true, new ConfigPotionEffect[] { new ConfigPotionEffect(PotionEffectType.SLOW, "%level% - 1", "160") }, new DamageCondition[0]);
	}
