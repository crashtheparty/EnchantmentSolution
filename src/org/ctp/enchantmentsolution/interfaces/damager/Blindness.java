...
public class Blindness extends DamagerAfflictEffect {

	public Blindness() {
		super(RegisterEnchantments.BLINDNESS, EnchantmentMultipleType.HIGHEST, EnchantmentItemLocation.ATTACKED, EventPriority.HIGHEST, true, new ConfigPotionEffect[] { new ConfigPotionEffect(PotionEffectType.BLINDNESS, "%level% - 1", "160") }, new DamageCondition[0]);
	}
