...
public class Venom extends DamagerAfflictEffect {

	public Venom() {
		super(RegisterEnchantments.VENOM, EnchantmentMultipleType.HIGHEST, EnchantmentItemLocation.ATTACKED, EventPriority.HIGHEST, true, new ConfigPotionEffect[] { new ConfigPotionEffect(PotionEffectType.POISON, "%level% - 1", "160") }, new DamageCondition[0]);
	}
