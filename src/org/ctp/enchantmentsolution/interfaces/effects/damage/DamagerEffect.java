...
public abstract class DamagerEffect extends EntityDamageEffect {
	...
	public DamagerEffect(EnchantmentWrapper enchantment, EnchantmentMultipleType type, EnchantmentItemLocation location, EventPriority priority, double incAmount,
	...
	public class DamagerResult extends EffectResult {

		private final double damage;

		public DamagerResult(int level, double damage) {
			super(level);
			this.damage = damage;
		}
