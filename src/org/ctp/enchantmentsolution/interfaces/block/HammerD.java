...
public class HammerD extends BlockRadiusMultiBreakEffect {

	public HammerD() {
		super(RegisterEnchantments.DEPTH_PLUS_PLUS, EnchantmentMultipleType.HIGHEST, EnchantmentItemLocation.ATTACKED, EventPriority.HIGHEST, "0", "0", "%level% * 10", true, true, true, true, true, new BlockCondition[] { new BlockGamemodeCondition(false, GameMode.SURVIVAL, GameMode.ADVENTURE), new BlockIsBreakingCondition(false), new BlockEntityIgnoredCondition(false) });
	}
