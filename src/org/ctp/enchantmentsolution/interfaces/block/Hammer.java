...
public class Hammer extends BlockRadiusMultiBreakEffect {

	public Hammer() {
		super(RegisterEnchantments.HEIGHT_PLUS_PLUS, EnchantmentMultipleType.HIGHEST, EnchantmentItemLocation.ATTACKED, EventPriority.HIGHEST, "%level%", "%level%", "0", true, true, false, true, false, new BlockCondition[] { new BlockGamemodeCondition(false, GameMode.SURVIVAL, GameMode.ADVENTURE), new BlockIsBreakingCondition(false), new BlockEntityIgnoredCondition(false) });
	}
