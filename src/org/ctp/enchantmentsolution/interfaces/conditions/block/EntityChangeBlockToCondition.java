...
public class EntityChangeBlockToCondition implements EntityBlockCondition {
	private final boolean opposite;
	private final MatData[] data;

	public EntityChangeBlockToCondition(boolean opposite, MatData... data) {
	...
	public boolean metCondition(Entity entity, Block block, EntityChangeBlockEvent event) {
		for (MatData mat : data)
			if (mat.hasMaterial() && mat.getMaterial() == event.getTo()) return !opposite;
		return opposite;
	}
