package org.ctp.enchantmentsolution.external_api.hu.trigary.advancementcreator;
...
import org.ctp.enchantmentsolution.external_api.hu.trigary.advancementcreator.trigger.LocationTrigger;
...
import org.ctp.enchantmentsolution.external_api.hu.trigary.advancementcreator.util.Validator;
...
public class Advancement {
	...
	public static boolean activate(boolean reload, NamespacedKey id, String json) {
		...
		ChatUtils.sendInfo("File Path: " + file.getAbsolutePath());
		if (!file.exists()) {
			try {
