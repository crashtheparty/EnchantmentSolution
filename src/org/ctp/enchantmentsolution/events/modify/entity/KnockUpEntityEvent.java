...
public class KnockUpEntityEvent extends ModifyEntityVelocityEvent implements KnockUpEvent {

	private LivingEntity damager;

	public KnockUpEntityEvent(LivingEntity damaged, int level, LivingEntity damager, double x, double y, double z) {
