...
public enum ESAdvancement {
	...
	REPAIRED(JUST_ADD_WATER, new NamespacedKey(EnchantmentSolution.getPlugin(), "enchantments/repaired"), 
			Arrays.asList(new ESLocalization(Language.US, "Repaired", "Put a tamed wolf into your Irene's Lasso")), "STONE_BRICKS",
	...
	BOOTS_WERE_MADE_FOR_WALKING(FLAME_KEEPER, new NamespacedKey(EnchantmentSolution.getPlugin(), "enchantments/boots_were_made_for_walking"), 
			Arrays.asList(new ESLocalization(Language.US, "Boots Were Made for Walking", "Walk over the void with Void Walker")), 
			"DIAMOND_BOOTS", Arrays.asList(new ESTrigger("boots", new ImpossibleTrigger())), new Rewards().setExperience(60), Frame.TASK),
	DETERMINED_CHEATER(BOOTS_WERE_MADE_FOR_WALKING, new NamespacedKey(EnchantmentSolution.getPlugin(), "enchantments/determined_cheater"), 
