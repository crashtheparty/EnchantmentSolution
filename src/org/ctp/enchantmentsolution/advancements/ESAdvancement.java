...
public enum ESAdvancement implements CrashAdvancement {
	...
	READY_AFTER_DEATH(KEPT_ON_HAND, "DIAMOND_CHESTPLATE", Arrays.asList(new CrashTrigger("soulbound")), 400, Frame.CHALLENGE),
	...
	SILVER_HORDE(EXTERMINATION, "INFESTED_COBBLESTONE", Arrays.asList(new CrashTrigger("infested", 8)), 75),
	BROKEN_DREAMS(PLAGUE_INC, "CYAN_CONCRETE", Arrays.asList(new CrashTrigger("unstable")), 50),
	ENVIRONMENTAL_PROTECTION(SCIENTIFIC_REVOLUTION, "EXPERIENCE_BOTTLE", Arrays.asList(new CrashTrigger("experience", 1000)), 300, Frame.CHALLENGE),
	...
	WORLD_RECORD(SCIENTIFIC_REVOLUTION, "SUNFLOWER", Arrays.asList(new CrashTrigger("record")), 400, Frame.CHALLENGE),
	...
	POSEIDONS_BANE(POSEIDONS_DAY_OFF, "TRIDENT", Arrays.asList(new CrashTrigger("trident")), 75),
	POSEIDON_REBORN(POSEIDONS_BANE, "TRIDENT", Arrays.asList(new CrashTrigger("trident")), 200, Frame.GOAL),
	...
	FOUR_HORSEMEN(IMPERIAL_REVOLUTION, "BONE", Arrays.asList(new CrashTrigger("skeleton")), 250, Frame.CHALLENGE),
	APOCALYPSE_NOW(FOUR_HORSEMEN, "DIAMOND_SWORD", Arrays.asList(new CrashTrigger("human", 100)), 1000, Frame.CHALLENGE),
