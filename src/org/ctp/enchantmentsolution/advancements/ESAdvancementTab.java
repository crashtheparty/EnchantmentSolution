...
public class ESAdvancementTab {
	...
	public static ESAdvancementTab AGRICULTURAL_REVOLUTION = new ESAdvancementTab(new AdvancementFactory(EnchantmentSolution.getPlugin(), false, false), Arrays.asList(ESAdvancement.AGRICULTURAL_REVOLUTION, ESAdvancement.FISH_STICKS, ESAdvancement.FED_FOR_A_LIFETIME, ESAdvancement.FISHY_BUSINESS, ESAdvancement.NEMO_ENIM_COQUIT, ESAdvancement.BONEMEAL_PLUS, ESAdvancement.JUST_AS_SWEET, ESAdvancement.NOT_THAT_KIND, ESAdvancement.HIGH_METABOLISM, ESAdvancement.CHICKEN_OR_THE_EGG, ESAdvancement.EGGED_BY_MYSELF, ESAdvancement.THORGY, ESAdvancement.FREE_PETS, ESAdvancement.WILDLIFE_CONSERVATION, ESAdvancement.MEAT_READY_TO_EAT, ESAdvancement.YUMMY_REPAIRS, ESAdvancement.HUNGRY_HIPPOS, ESAdvancement.THUMBS_UP, ESAdvancement.REFORESTATION, ESAdvancement.ANIMAL_ABUSE, ESAdvancement.ANIMAL_TAMER), "block/hay_block_side");
