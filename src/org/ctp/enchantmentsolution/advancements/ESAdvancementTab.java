...
public class ESAdvancementTab {
	...
	public static ESAdvancementTab AGRICULTURAL_REVOLUTION = new ESAdvancementTab(new AdvancementFactory(EnchantmentSolution.getPlugin(), false, false), Arrays.asList(ESAdvancement.AGRICULTURAL_REVOLUTION, ESAdvancement.FISH_STICKS, ESAdvancement.FED_FOR_A_LIFETIME, ESAdvancement.FISHY_BUSINESS, ESAdvancement.NEMO_ENIM_COQUIT, ESAdvancement.BONEMEAL_PLUS, ESAdvancement.JUST_AS_SWEET, ESAdvancement.NOT_THAT_KIND, ESAdvancement.HIGH_METABOLISM, ESAdvancement.FOURTY_NINERS, ESAdvancement.CHICKEN_OR_THE_EGG, ESAdvancement.EGGED_BY_MYSELF, ESAdvancement.THORGY, ESAdvancement.FREE_PETS, ESAdvancement.WILDLIFE_CONSERVATION, ESAdvancement.MEAT_READY_TO_EAT, ESAdvancement.YUMMY_REPAIRS, ESAdvancement.HUNGRY_HIPPOS, ESAdvancement.THUMBS_UP, ESAdvancement.REFORESTATION, ESAdvancement.ANIMAL_ABUSE, ESAdvancement.ANIMAL_TAMER, ESAdvancement.FLYING_BACON), "block/hay_block_side");

	public static ESAdvancementTab INDUSTRIAL_REVOLUTION = new ESAdvancementTab(new AdvancementFactory(EnchantmentSolution.getPlugin(), false, false), Arrays.asList(ESAdvancement.INDUSTRIAL_REVOLUTION, ESAdvancement.EASY_OUT, ESAdvancement.JUST_ADD_WATER, ESAdvancement.REPAIRED, ESAdvancement.FLAME_KEEPER, ESAdvancement.DETERMINED_CHEATER, ESAdvancement.IRONT_YOU_GLAD, ESAdvancement.FAST_AND_FURIOUS, ESAdvancement.CARPET_BOMBS, ESAdvancement.OVER_9000, ESAdvancement.HEY_IT_WORKS, ESAdvancement.NO_PANIC, ESAdvancement.STAINLESS_STEEL, ESAdvancement.NETHER_DULL, ESAdvancement.SPARKLING_FORTUNE, ESAdvancement.SCOURGE_OF_THE_FOREST, ESAdvancement.DEFORESTATION), "block/hopper_outside");

	public static ESAdvancementTab SCIENTIFIC_REVOLUTION = new ESAdvancementTab(new AdvancementFactory(EnchantmentSolution.getPlugin(), false, false), Arrays.asList(ESAdvancement.SCIENTIFIC_REVOLUTION, ESAdvancement.BREAKER_BREAKER, ESAdvancement.USELESS, ESAdvancement.DID_YOU_REALLY_WAND_TO_DO_THAT, ESAdvancement.SHARING_IS_CARING, ESAdvancement.LAAAGGGGGG, ESAdvancement.KEPT_ON_HAND, ESAdvancement.FEAR_THE_REAPER, ESAdvancement.READY_AFTER_DEATH, ESAdvancement.REAPED_THE_REAPER, ESAdvancement.PLAGUE_INC, ESAdvancement.EXTERMINATION, ESAdvancement.SILVER_HORDE, ESAdvancement.BROKEN_DREAMS, ESAdvancement.ENVIRONMENTAL_PROTECTION, ESAdvancement.BLIND_AS_A_BAT, ESAdvancement.LIGHT_AS_A_FEATHER, ESAdvancement.WORLD_RECORD, ESAdvancement.REPLENISHED, ESAdvancement.THE_SNOWMAN), "block/bookshelf");

	public static ESAdvancementTab IMPERIAL_REVOLUTION = new ESAdvancementTab(new AdvancementFactory(EnchantmentSolution.getPlugin(), false, false), Arrays.asList(ESAdvancement.IMPERIAL_REVOLUTION, ESAdvancement.HEX_BAG, ESAdvancement.SUPER_CHARGED, ESAdvancement.DOUBLE_DAMAGE, ESAdvancement.SEVEN_POINT_EIGHT, ESAdvancement.NOT_VERY_EFFECTIVE, ESAdvancement.SUPER_EFFECTIVE, ESAdvancement.YEET, ESAdvancement.PRE_COMBAT_UPDATE, ESAdvancement.HEADHUNTER, ESAdvancement.DOUBLE_HEADER, ESAdvancement.SPOOKY_SCARY_SKELETON, ESAdvancement.MOTHERLOAD, ESAdvancement.POSEIDONS_DAY_OFF, ESAdvancement.POSEIDONS_BANE, ESAdvancement.POSEIDON_REBORN, ESAdvancement.CERBERUS, ESAdvancement.MISSED, ESAdvancement.SAVING_GRACE, ESAdvancement.LOOK_WHAT_YOU_MADE_ME_DO, ESAdvancement.JUST_DIE_ALREADY, ESAdvancement.UNDERKILL, ESAdvancement.WHERE_DID_THAT_COME_FROM, ESAdvancement.KILL_THE_MESSENGER, ESAdvancement.BLAST_OFF, ESAdvancement.PENETRATION, ESAdvancement.KILIMANJARO, ESAdvancement.KNOCKBACK_REVERSED, ESAdvancement.BEFORE_I_MELT_AWAY, ESAdvancement.FOUR_HORSEMEN, ESAdvancement.APOCALYPSE_NOW), "block/diamond_block");
